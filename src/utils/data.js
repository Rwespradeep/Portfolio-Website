...
export const workExp = [
  {
    place: "Systems Engineer, Infosys",
  ...
  },
  {
    ...
    detail:
      "With my curiosity in web development, Upskilled myself to React. Made projects like these(one you are viewing) integrating them with firebase and redux",
  },
];
